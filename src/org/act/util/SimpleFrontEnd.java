...
//				msp.getTextPane().setText("CForm[ToExpression[Import[\"d:\\1.mml\",\"MathML\"]]]");
				msp.getTextPane().requestFocus();
//				msp.setText("CForm[ToExpression[Import[\"d:\\1.mml\",\"MathML\"]]]");
//				msp.setText("CForm[ToExpression[Import[\"d:\\1.mml\",\"MathML\"]]]");
//				msp.evaluateInput();
//				System.out.println(msp.getText());
	...
	class MenuItemHandler implements ActionListener {
		...
		public void actionPerformed(ActionEvent evt) {
			...
			if (source == exitItem) {
				...
				System.out.println(msp.getTextPane().getText());
//				msp.setText("CForm[ToExpression[Import[\"d:\\1.mml\",\"MathML\"]]]");
//				msp.getTextPane().setText("CForm[ToExpression[Import[\"d:\\1.mml\",\"MathML\"]]]");
				System.out.println(msp.getTextPane().getText());
				msp.evaluateInput();
...
class LaunchDialog extends JDialog {
	...
	LaunchDialog(Frame parent) {
		...
		if (Utils.isWindows())
			defaultPath = "d:\\Program Files\\Wolfram Research\\Mathematica\\9.0\\MathKernel";
