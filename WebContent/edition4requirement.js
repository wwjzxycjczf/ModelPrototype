...
//	Log(jsonToString(links));
	...
	for(var i=0;i<stacks.length;i++){
		...
		var formula = stacksarr[stacksarr.length-2].substring(7,stacksarr[stacksarr.length-2].indexOf('.'));
		var formulastr = "<formula id=\""+formula+"\" name=\""+formula+".xml\">\n";
