...
<script type="text/javascript"  src="drawsvgnew3.js"></script>
<!--<script src="d3.js"></script>-->
...
密码:  <input type="password" id="pwd" /><p id="t_pass"></p>
        <br />
        <button id='loginbutton' type="button" onclick='loginClicked();'>登陆</button>
        <br />
         <div id='tips' ></div>
        </form>
     </div>
	...
	<form name="upform" action="FileUpLoad" method="post" enctype="multipart/form-data">
    ...
    <div>  
        	...
        	<input type='button' class='btn' value='Input MathML formula' /> 
        	<input type="file" name="fileField" class="file2" id="fmathml" size="28" />   
        	<input type='button' class='btn1' value='Input Doc formula' onClick="DocFormulaClick()" /> 
...
if(success=="File upload successfully!!!"){
...
document.getElementById("math").innerHTML = "load file 成功";
<%
}
%>
